...
Node RequestHandler::execute_make_node_route(StatRequest& request,  TransportCatalogue& catalogue, TransportRouter& routing) {
...
std::optional<RouteInfo> RequestHandler::get_route_info(std::string_view start,  std::string_view end, TransportCatalogue& catalogue, TransportRouter& routing) const {
