...
int main(int argc, char* argv[]) {
    ...
    if (mode == "make_base"sv) {
        ...
        json_reader.parse_node_make_base(transport_catalogue, render_settings, routing_settings, serialization_settings);
        ...
        request_handler.execute_queries(catalogue.transport_catalogue_, stat_request, catalogue.render_settings_, catalogue.routing_settings_);
